...
namespace Loja1._0
{
    public partial class MovimentoData : Form
    {
        ...
        public MovimentoData(Model.Usuarios user)
        {
            this.user = user;
            InitializeComponent();
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                listaMovimentos = controle.PesquisaMovPeriodo(dataInicio, dataFim);
        ...
        private void preencheDataGrindView(List<Movimentos> listaMovimentos)
        {
            ...
            catch
            {
                ...
                erro = "MovimentoData.cs, instrução \"preencheDataGrindView\"";              
